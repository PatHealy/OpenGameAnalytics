...
CREATE TABLE IF NOT EXISTS user_info (
	pk_user_info_id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS play_session (
	pk_play_session_id INTEGER PRIMARY KEY AUTOINCREMENT,
    fk_user_id INT,
    FOREIGN KEY (fk_user_id) REFERENCES user(pk_user_id)
);

CREATE TABLE IF NOT EXISTS play_session_start (
	pk_play_session_start_id INTEGER PRIMARY KEY AUTOINCREMENT,
	created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS play_session_continue (
	pk_play_session_continue_id INTEGER PRIMARY KEY AUTOINCREMENT,
	created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    fk_play_session_id INT,
    FOREIGN KEY (fk_play_session_id) REFERENCES play_session(pk_play_session_id)
);
...
CREATE TABLE IF NOT EXISTS play_session_end (
	pk_play_session_end_id INTEGER PRIMARY KEY AUTOINCREMENT,
	created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    fk_play_session_id INT,
    FOREIGN KEY (fk_play_session_id) REFERENCES play_session(pk_play_session_id)
);
...
CREATE TABLE IF NOT EXISTS play_action (
	pk_play_action_id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS independent_point (
	pk_independent_point_id INTEGER PRIMARY KEY AUTOINCREMENT,
    attribute_name varchar(50),
    info TEXT,
	created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    fk_user_id INT,
...
CREATE TABLE IF NOT EXISTS dependent_point (
    pk_dependent_point_id INTEGER PRIMARY KEY AUTOINCREMENT,
    attribute_name varchar(50),
    info TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    fk_user_id INT,
